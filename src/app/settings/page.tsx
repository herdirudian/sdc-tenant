    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {/* SMTP Help/Guide */}
          <div className="rounded-xl bg-blue-50 p-4 text-sm text-blue-800 border border-blue-100 dark:bg-blue-950/30 dark:text-blue-200 dark:border-blue-900/50">
            <div className="font-semibold flex items-center gap-2 mb-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
              Panduan Konfigurasi Gmail
            </div>
            <ul className="list-disc ml-5 space-y-1">
              <li><b>SMTP Host:</b> smtp.gmail.com</li>
              <li><b>SMTP Port:</b> 465 (Centang Secure) atau 587 (Tanpa Secure)</li>
              <li><b>SMTP Password:</b> Gunakan <b>App Password</b> (16 karakter), bukan password login utama.</li>
              <li>Pastikan <b>Verifikasi 2 Langkah</b> sudah aktif di akun Google Anda.</li>
              <li>Buat App Password di <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noopener noreferrer" className="underline font-medium hover:text-blue-600 dark:hover:text-blue-400">Google Security Settings</a>.</li>
            </ul>
          </div>
